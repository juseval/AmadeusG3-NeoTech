    ...
    <>
      ...
      <div className="container">
        <div className="container__encabezado">
          ...
          <h1 className="container__encabezado__titulo">
          ...
          <div className="container__encabezado__imagen">
            <img
              className="img"
              src={img}
              alt="Imagen del destino seleccionado"
            />
          </div>
        ...
        <div className="container__hospedaje">
          <h2 className="container__encabezado__nombre">
            Tus opciones de hospedaje:
          </h2>
          ...
          <div className="container__hospedaje__opciones">
            <div className="container__hospedaje__opcion">
              ...
              <div className="container__hospedaje__opcion__info">
                ...
                <p>
                  Explora alojamientos únicos, desde acogedores apartamentos en
                  el corazón de la ciudad hasta exóticas casas en árboles. Viaja
                  de una manera más auténtica y personalizada, creando recuerdos
                  inolvidables en cada destino.
                </p>
                <a
                  className="container_hospedaje_button"
                  target="_blank"
        ...
        <div className="container__vuelos">
          ...
          <div className="container__vuelos__opciones">
            <div className="container__vuelos__opcion">
              <div className="container__hospedaje__opcion__img">
                <img
                  className="img__vuelo"
                  src="./Avianca.png"
                  alt="Imagen de un avión de Avianca"
                />
              </div>
              ...
              <div className="container__hospedaje__opcion__info">
                ...
                <p className="txt-parrafo">
                  es la aerolínea bandera de Colombia y una de las más grandes
                  de América Latina. Fundada en 1919, opera vuelos a más de 90
                  destinos en América, Europa, Asia y el Caribe. Es miembro de
                  la alianza Star Alliance y se enfoca en ofrecer un servicio
                  excepcional y conexiones globales a sus pasajeros
                </p>
                <a
                  className="container_vuelos_button"
                  target="_blank"
            ...
            <div className="container__vuelos__opcion">
              <div className="container__hospedaje__opcion__img">
                <img
                  className="img__vuelo"
                  src="./Air-Europa-logo.png"
                  alt="Imagen de un avión de Aeromexico"
                />
              </div>
              ...
              <div className="container__hospedaje__opcion__info">
                ...
                <p className="txt-parrafo">
                  Es una aerolínea española fundada en 1984, con sede en
                  Lluchmayor, Mallorca. Es miembro de la alianza SkyTeam y opera
                  vuelos a más de 130 destinos en todo el mundo. La aerolínea se
                  compromete con altos estándares de calidad y seguridad, y
                  ofrece servicios como entretenimiento a bordo, menús
                  exquisitos y prioridad en el embarque.
                </p>
                <a
                  className="container_vuelos_button"
                  target="_blank"
